                ...
                <div className="side-info-content">
                    <div className="mm-menu">
                        <ul>
                            ...
                            <li><Link href="/service-details">Services</Link></li>
                    ...
                    <div className="contact-infos mb-30">
                        <div className="contact-list mb-30">
                            <h4>Contact Info</h4>
                            <ul>
                                <li><Image src={icon1} style={{ width: "auto", height: "auto" }} alt="icon not found" />3768 E Hastings St., Burnaby, BC</li>
                                <li><Image src={icon2} style={{ width: "auto", height: "auto" }} alt="icon not found" /><Link href="swapsolutionz@gmail.com">swapsolutionz@gmail.com</Link></li>
                                <li><Image src={icon3} style={{ width: "auto", height: "auto" }} alt="icon not found" /><Link href="tel:6045000030">+1 604-500-0030</Link></li>
                            </ul>
                            <div className="sidebar__menu--social">
                                <a href="https://www.linkedin.com/company/swap-solutions-canada/about/" target="_blank" rel="noreferrer"><i className="fab fa-linkedin"></i></a>
                                <a href="https://www.facebook.com/swapsolutions" target="_blank" rel="noreferrer"><i className="fab fa-facebook-f"></i></a>
                                <a href="https://www.instagram.com/swapsolutions/?hl=en" target="_blank" rel="noreferrer"><i className="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
